...
# some helper for Gnuplot
g1 = Gnuplot.Gnuplot()
g2 = Gnuplot.Gnuplot()
g3 = Gnuplot.Gnuplot()
g4 = Gnuplot.Gnuplot()
g1('splot "'+datafile+'" with dots')
g2('plot "out.dat" with points')
g3('plot "'+datafile+'" with dots')
g3('replot "out.dat" with points')
g3.load("out.gnu")
g4('unset key')
g4('plot "capitalsnames.dat" with labels')